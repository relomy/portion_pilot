...
describe('index.css', () => {
  ...
  it('styles the zone layout shell selectors', () => {
    ...
    expect(css).toContain('.density-primary')
    expect(css).toContain('.density-secondary')
    expect(css).toContain('.density-secondary__item')
    expect(css).toContain('.wc-callout')
    expect(css).toContain('.wc-callout__value')
    expect(css).toContain('.wc-callout__copy')
    expect(css).toContain('.portion-inputs')
    expect(css).toContain('.answers')
    expect(css).toContain('.answer-row')
    expect(css).toContain('.answer-row--reference')
    expect(css).toContain('.hero-answer')
    expect(css).toContain('.hero-answer__value')
  })
